...
public class Camera2Controller {
    ...
    public Camera2Controller(Context context, ICameraListener listener, AutoFitTextureView textureView){
        this.mContext = context;
    ...
    private void openCamera(int width, int height) {
        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.CAMERA)
            ...
            mListener.onPermissionNotGiven();
            return;
        }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            mListener.onCameraNotAvailable();
        }
    }
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            if (mListener!=null){
                mListener.onPictureTaken(reader.acquireLatestImage(), mSensorOrientation, mPreviewSize);
            }
        }
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.e("Camera2Controller", "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
